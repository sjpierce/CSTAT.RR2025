...
[@Pierce-RN8692]. Its primary purpose is for me to use version control tools 
...
* `CSTAT.RR2025/`: This is the root folder for the repository.
    ...
    * `_brand.yml`: This file contains color palette, font, and logo settings 
      for CSTAT branding that get applied across slides and other outputs.  
    ...
    * `CSTAT_theme.css`: This is custom style sheet file to provide formatting 
      settings and classes for my slides and other HTML outputs. It supplements
      `_brand.yml`. 
...
* Double-click the `CSTAT.RR2025.Rproj` file from Windows Explorer to open 
  the RStudio project.
...
Please cite my actual presentation [@Pierce-RN8692]. 
