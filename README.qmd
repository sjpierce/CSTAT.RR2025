...
* `CSTAT.RR2025/`: This is the root folder for the repository.
    ...
    * `CSTAT_style.css`: This is custom style sheet file to provide formatting 
      settings and classes for my HTML outputs. It supplements `_brand.yml` 
      and `CSTAT_theme.scss`. Specifically, this sets up the logo and title 
      banner formatting at the top of the output.
